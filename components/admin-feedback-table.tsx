...
import { STATUS_GROUPS, STATUS_ORDER } from "@/app/data/status";
...
export function AdminFeedbackTable({
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Gerencie os feedbacks</CardTitle>
      </CardHeader>
      <CardContent>
        <Table>
          <TableHeader>
              ...
              return (
                <TableRow key={post.id} className="h-[70px]">
                  ...
                  <TableCell className="align-middle">
                    <Badge
                      variant="outline"
                      className={cn(categoryDesign.text, categoryDesign.border)}
                    >
