...
import { getCategoryDesign } from "../data/category";
      ...
      <div className="space-y-6">
        ...
        >
          <div className="flex gap-4 justify-center pt-4">
            ...
            >
              <Link href="/roadmap">
                <Map className="h-4 w-4 mr-2" /> Veja o roadmap
              </Link>
            </Button>
          </div>
        </GradientHeader>
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Procure feedbacks por categoria
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center gap-3">
                          ...
                          >
                            <Icon className={cn("h-4 w-4", design.text)}></Icon>
                          </div>
                        ...
                        <Badge
                          variant="secondary"
                          className={cn(design.light, design.text)}
                        >
                          {cat._count}
                        </Badge>
                      </div>
